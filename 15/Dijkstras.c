...
Enter the source vertex : 0
  ...
  Shortest distance for all nodes from 0 : 0   10  20  30
HeapCount : 10   GraphCount : 12

  # Set the terminal to PNG with specific size
set terminal pngcairo size 800,600
set output 'dijkstra_plot.png'

# Set title and labels
set title "Dijkstra's Algorithm Performance"
...
plot 'dikstras.txt' using 1:2 with linespoints title 'Operation Count' lc rgb "blue"

  In terminal
gnuplot plot_dijkstra.gnu
